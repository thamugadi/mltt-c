...
CFLAGS := -O3 -ffast-math -I src/include -std=c2x -pedantic -Wall -Wextra -Wshadow -Wunreachable-code -Wno-unused-parameter -Wno-unused-label -Wno-constant-logical-operand 
